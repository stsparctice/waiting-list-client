...
const Insert = (idPatient) => {
    ...
    return <>
        <form className={css.form}>
            ...
            <Checkbox title="רמת הטיפול:" type="checkbox" arr={treatmentLevel}>
            </Checkbox>

            <Checkbox title="רמת דחיפות:" type="radio" arr={treatmentPreference}>
            </Checkbox>

            <Checkbox title="אבחון:" type="radio" arr={[{ text: "אבחון", color: 'rgb(122, 3, 122)', checked: false }
                , { text: "אין צורך באבחון", color: 'rgb(122, 3, 122)', checked: false }]}>
            </Checkbox>
            {/* <p>
                <label >מורים:</label>
